...
fetch("https://moviestack.onrender.com/api/movies", {headers: {"x-api-key":"0ff70d54-dc0b-4262-9c3d-776cb0f34dbd"}})
    ...
    .then( peliculasApi => {
        ...
        <article class="flex flex-col items-center justify-center bg-slate-600 text-white gap-3 p-2 border rounded-2xl w-full xl:w-2/3 mx-20 min-w-72 text-center" >
            <div class="flex flex-col gap-3 lg:flex-row">
                <div class="lg:w-2/4">
                    <img class="w-full object-cover " src="https://moviestack.onrender.com/static/${pelicula.image}" alt= "Una imágen ilustrativa de la película '${pelicula.title}'" >
                </div>
